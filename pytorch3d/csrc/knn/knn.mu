...
#include "utils/dispatch.muh"
#include "utils/mink.muh"
...
std::tuple<at::Tensor, at::Tensor> KNearestNeighborIdxMusa(
  ...
  if (version == 0) {
    AT_DISPATCH_FLOATING_TYPES(
        p1.scalar_type(), "knn_kernel_musa", ([&] {
    ...
    AT_DISPATCH_FLOATING_TYPES(p1.scalar_type(), "knn_kernel_musa", ([&] {
                                 DispatchKernel1D<
...
std::tuple<at::Tensor, at::Tensor> KNearestNeighborBackwardMusa(
    const at::Tensor& p1,
    const at::Tensor& p2,
    const at::Tensor& lengths1,
    const at::Tensor& lengths2,
  ...
  at::CheckedFrom c = "KNearestNeighborBackwardMusa";
  at::checkAllSameGPU(
  ...
  at::globalContext().alertNotDeterministic("KNearestNeighborBackwardMusa");
